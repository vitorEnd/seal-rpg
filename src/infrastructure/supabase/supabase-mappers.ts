...
export function mapCharacterClassOptionRow(
  ...
  return {
    ...
    attributeBonuses: {
      ...
      resilience: row.bonus_resilience,
      intellect: row.bonus_intellect,
      presence: row.bonus_presence,
      energy: row.bonus_energy,
      adaptation: row.bonus_adaptation,
    },
    order: row.sort_order,
    active: row.active,
    createdAt: row.created_at,
...
export function mapCharacterRow(row: TableRow<"characters">): Character {
  return {
    ...
    attributes: {
      ...
      resilience: row.attribute_resilience,
      intellect: row.attribute_intellect,
      presence: row.attribute_presence,
      energy: row.attribute_energy,
      adaptation: row.attribute_adaptation,
    },
    coverImageUrl: row.cover_image_url,
    coverImageStorageKey: row.cover_image_storage_key,
    backgroundImageUrl: row.background_image_url,
